...
int main()
{
    ...
    /*Since a and b are both pointers yes we can do this. a is now pointing to 
     *the same thing b is pointing to*/
    a = b;
    printf("\n a's value is now: %p, same as 'b'... it seems we can, but can\n"
    "we do it in a function? lets see... \n", a);
    printf("\n cant_change(a, f); \n");
    cant_change(a, f);
    printf("\n a's value is now: %p, Doh! still same as 'b'...that function \n"
    "tricked us. \n", a);
     ...
     *in this instance. */
    printf("\n NOW! lets see if a pointer to a pointer solution can help us..."
    "remember that 'pp' point to 'a' \n");
